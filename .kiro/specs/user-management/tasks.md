...
- [ ] 1. Create utility functions and property tests
  - [ ] 1.1 Create `src/utils/userManagement.js` with sortUsers, filterUsers, roleDisplayLabel, and formatUserCount functions
  ...
  - [ ]* 1.2 Write property test for sortUsers ordering invariant
  ...
  - [ ]* 1.3 Write property test for roleDisplayLabel mapping
  ...
  - [ ]* 1.4 Write property test for filterUsers correctness
  ...
  - [ ]* 1.5 Write property test for formatUserCount string format
...
- [ ] 3. Implement UserManagementPage component
  - [ ] 3.1 Create `src/pages/UserManagement.jsx` with full page implementation
  ...
  - [ ]* 3.2 Write unit tests for UserManagementPage
...
- [ ] 4. Register route and update navigation
  - [ ] 4.1 Add `/users` route in `src/App.jsx` with ProtectedRoute roles={["admin"]}
  ...
  - [ ] 4.2 Add "Users" button to `src/components/Navbar.jsx` visible only for admin role
  ...
  - [ ]* 4.3 Write unit tests for route access control and navbar visibility
...
- [ ] 6. Update Firestore security rules
  - [ ] 6.1 Update `firestore.rules` to enforce admin-only user collection access
  ...
  - [ ]* 6.2 Write integration tests for Firestore security rules
